...
import type { StreakData, DailyRecord } from './types/index.js'
 ...
 */
export function streakQualifies(record: DailyRecord): boolean {
 ...
 */
export function calculateStreak(current: StreakData, todayQualifies: boolean): StreakData {
