 ...
 */
export const REFLECTION_THRESHOLD_SECONDS = 1800;
/**
 ...
 */
export function shouldTriggerReflection(session) {
 ...
 */
export function createReflectionEntry(session, durationSeconds) {
    return {
 ...
 */
export function resolveReflection(entry, solvedByAI) {
    return {
        ...entry,
        solvedByAI
    };
 ...
 */
export function getReflectionMessage(domain, durationSeconds) {
